...
if any(mount.mountPoint == "/mnt/data-storage-1421" for mount in mounts):
    print("O bucket já está montado.")
else:
    aws_access_key_id = "AKIAW3MEFNELAYYWDAT2"
    aws_secret_access_key = "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"

    dbutils.fs.mount(
        source="s3a://data-storage-1421",
        mount_point="/mnt/data-storage-1421",
        extra_configs={
...
# MAGIC %md
# MAGIC ####3.5 Justificativa para Exclusão de Colunas com Muitos Valores Nulos
# MAGIC
...
# MAGIC %md
# MAGIC ####3.5.1. Justificativa para Exclusão de Colunas com Muitos Valores Nulos
# MAGIC
# MAGIC Após a conversão das colunas categóricas para valores numéricos, verifiquei e justifiquei a exclusão das colunas que apresentavam muitos valores nulos:
# MAGIC
...
# MAGIC %md
# MAGIC ####3.4. Preparação da Conversão dos dados  
...
colunas_para_indexar = [
    "Tipo de Hospital_Index",
    "Propriedade Hospitalar_Index",
    "Servicos de Emergencia_Index",
    "Atende aos Criterios para Uso Significativo de EHRs",
    "Nota de Rodape sobre Classificacao Geral do Hospital",
    "Comparacao Nacional de Mortalidade_Index",
    "Nota de Rodape sobre Comparacao Nacional de Mortalidade",
    "Comparacao Nacional de Seguranca do Atendimento_Index",
    "Nota de Rodape sobre Comparacao Nacional de Seguranca do Atendimento",
    "Comparacao Nacional de Readmissao_Index",
    "Nota de Rodape sobre Comparacao Nacional de Readmissao",
    "Comparacao Nacional da Experiencia do Paciente_Index",
    "Nota de Rodape sobre Comparacao Nacional da Experiencia do Paciente",
    "Comparacao Nacional da Efetividade do Atendimento_Index",
    "Nota de Rodape sobre Comparacao Nacional da Efetividade do Atendimento",
    "Comparacao Nacional da Pontualidade do Atendimento_Index",
    "Nota de Rodape sobre Pontualidade do Atendimento",
    "Comparacao Nacional do Uso Eficiente de Imagens Medicas_Index",
    "Nota de Rodape sobre Uso Eficiente de Imagens Medicas",
]
...
df_indexed = pipeline.fit(df_limpo1).transform(df_limpo1)
...
# MAGIC -- Criar a tabela Dim_Provedor
# MAGIC CREATE TABLE Dim_Provedor (ID_Provedor_Index STRING);
# MAGIC -- Inserir dados na tabela Dim_Provedor
# MAGIC INSERT INTO
# MAGIC   Dim_Provedor
# MAGIC SELECT
# MAGIC   DISTINCT `ID do Provedor_Index` AS ID_Provedor_Index
# MAGIC FROM
# MAGIC   df_final;
...
# MAGIC   Dim_Tipo_Hospital
# MAGIC SELECT
# MAGIC   DISTINCT `Tipo de Hospital_Index_Index` AS Tipo_Hospital_Index,
# MAGIC   `Propriedade Hospitalar_Index_Index` AS Propriedade_Hospitalar_Index
# MAGIC FROM
# MAGIC   df_final;
...
# MAGIC   ID_Provedor_Index STRING,
# MAGIC   Estado_Index STRING,
# MAGIC   Tipo_Hospital_Index STRING,
# MAGIC   Comparacao_Seguranca_Cuidado_Index STRING,
# MAGIC   Comparacao_Readmissao_Index STRING,
# MAGIC   Comparacao_Experiencia_Paciente_Index STRING,
# MAGIC   Comparacao_Efetividade_Cuidado_Index STRING,
# MAGIC   Comparacao_Pontualidade_Cuidado_Index STRING,
# MAGIC   Comparacao_Uso_Eficiente_Imagem_Index STRING
# MAGIC );
...
# MAGIC SELECT
# MAGIC   DISTINCT `ID do Provedor_Index` AS ID_Provedor_Index,
# MAGIC   Estado AS Estado_Index,
# MAGIC   `Tipo de Hospital_Index_Index` AS Tipo_Hospital_Index,
# MAGIC   `Comparacao Nacional de Seguranca do Atendimento_Index_Index` AS Comparacao_Seguranca_Cuidado_Index,
# MAGIC   `Comparacao Nacional de Readmissao_Index_Index` AS Comparacao_Readmissao_Index,
# MAGIC   `Comparacao Nacional da Experiencia do Paciente_Index_Index` AS Comparacao_Experiencia_Paciente_Index,
# MAGIC   `Comparacao Nacional da Efetividade do Atendimento_Index_Index` AS Comparacao_Efetividade_Cuidado_Index,
# MAGIC   `Comparacao Nacional da Pontualidade do Atendimento_Index_Index` AS Comparacao_Pontualidade_Cuidado_Index,
# MAGIC   `Comparacao Nacional do Uso Eficiente de Imagens Medicas_Index_Index` AS Comparacao_Uso_Eficiente_Imagem_Index
# MAGIC FROM
# MAGIC   df_final;
...
# MAGIC   DISTINCT `ID do Provedor_Index` AS ID_Provedor_Index,
# MAGIC   `Propriedade Hospitalar_Index_Index` AS Propriedade_Hospitalar_Index,
# MAGIC   `Comparacao Nacional de Mortalidade_Index_Index` AS Comparacao_Mortalidade_Index,
# MAGIC   `Comparacao Nacional de Readmissao_Index_Index` AS Comparacao_Readmissao_Index
# MAGIC FROM
# MAGIC   df_final;
...
# MAGIC   Fato_Efetividade_Readmissao
# MAGIC SELECT
# MAGIC   DISTINCT `ID do Provedor_Index`,
# MAGIC   `Comparacao Nacional da Efetividade do Atendimento_Index_Index`,
# MAGIC   `Comparacao Nacional de Readmissao_Index_Index`
# MAGIC FROM
# MAGIC   df_final;
...
# MAGIC   DISTINCT `ID do Provedor_Index`,
# MAGIC   `Estado`,
# MAGIC   `Comparacao Nacional de Seguranca do Atendimento_Index_Index`
# MAGIC FROM
# MAGIC   df_final;
...
# MAGIC
# MAGIC **2. Estatísticas Descritivas**
# MAGIC
...
# MAGIC   MIN(
# MAGIC     CAST(
# MAGIC       `Comparacao Nacional de Seguranca do Atendimento_Index_Index` AS INT
# MAGIC     )
# MAGIC   ) AS `Seguranca Atendimento`,
# MAGIC   MIN(
# MAGIC     CAST(
# MAGIC       `Comparacao Nacional de Readmissao_Index_Index` AS INT
# MAGIC     )
# MAGIC   ) AS `Readmissao`,
# MAGIC   MIN(
# MAGIC     CAST(
# MAGIC       `Comparacao Nacional da Experiencia do Paciente_Index_Index` AS INT
# MAGIC     )
# MAGIC   ) AS `Experiencia Paciente`,
# MAGIC   MIN(
# MAGIC     CAST(
# MAGIC       `Comparacao Nacional da Efetividade do Atendimento_Index_Index` AS INT
# MAGIC     )
# MAGIC   ) AS `Efetividade Atendimento`,
# MAGIC   MIN(
# MAGIC     CAST(
# MAGIC       `Comparacao Nacional da Pontualidade do Atendimento_Index_Index` AS INT
# MAGIC     )
# MAGIC   ) AS `Pontualidade Atendimento`,
# MAGIC   MIN(
# MAGIC     CAST(
# MAGIC       `Comparacao Nacional do Uso Eficiente de Imagens Medicas_Index_Index` AS INT
# MAGIC     )
...
# MAGIC   AVG(
# MAGIC     CAST(
# MAGIC       `Comparacao Nacional de Seguranca do Atendimento_Index_Index` AS DOUBLE
# MAGIC     )
# MAGIC   ) AS `Seguranca Atendimento`,
# MAGIC   AVG(
# MAGIC     CAST(
# MAGIC       `Comparacao Nacional de Readmissao_Index_Index` AS DOUBLE
# MAGIC     )
# MAGIC   ) AS `Readmissao`,
# MAGIC   AVG(
# MAGIC     CAST(
# MAGIC       `Comparacao Nacional da Experiencia do Paciente_Index_Index` AS DOUBLE
# MAGIC     )
# MAGIC   ) AS `Experiencia Paciente`,
# MAGIC   AVG(
# MAGIC     CAST(
# MAGIC       `Comparacao Nacional da Efetividade do Atendimento_Index_Index` AS DOUBLE
# MAGIC     )
# MAGIC   ) AS `Efetividade Atendimento`,
# MAGIC   AVG(
# MAGIC     CAST(
# MAGIC       `Comparacao Nacional da Pontualidade do Atendimento_Index_Index` AS DOUBLE
# MAGIC     )
# MAGIC   ) AS `Pontualidade Atendimento`,
# MAGIC   AVG(
# MAGIC     CAST(
# MAGIC       `Comparacao Nacional do Uso Eficiente de Imagens Medicas_Index_Index` AS DOUBLE
# MAGIC     )
# MAGIC   ) AS `Uso Eficiente de Imagens`
# MAGIC FROM
# MAGIC   df_final
...
# MAGIC %md
# MAGIC ####Verificar as Categorias em Cada Coluna e Contar as Frequências
...
# MAGIC     `Comparacao Nacional de Seguranca do Atendimento_Index_Index` AS Valor,
...
# MAGIC     `Comparacao Nacional de Readmissao_Index_Index` AS Valor,
# MAGIC     COUNT(*) AS Quantidade
# MAGIC   FROM
# MAGIC     df_final
# MAGIC   GROUP BY
...
# MAGIC     `Comparacao Nacional da Experiencia do Paciente_Index_Index` AS Valor,
# MAGIC     COUNT(*) AS Quantidade
# MAGIC   FROM
# MAGIC     df_final
# MAGIC   GROUP BY
# MAGIC     `Comparacao Nacional da Experiencia do Paciente_Index_Index`
# MAGIC   UNION ALL
# MAGIC   SELECT
# MAGIC     'Efetividade Atendimento' AS Categoria,
# MAGIC     `Comparacao Nacional da Efetividade do Atendimento_Index_Index` AS Valor,
# MAGIC     COUNT(*) AS Quantidade
# MAGIC   FROM
# MAGIC     df_final
# MAGIC   GROUP BY
...
# MAGIC     `Comparacao Nacional da Pontualidade do Atendimento_Index_Index` AS Valor,
# MAGIC     COUNT(*) AS Quantidade
# MAGIC   FROM
# MAGIC     df_final
# MAGIC   GROUP BY
# MAGIC     `Comparacao Nacional da Pontualidade do Atendimento_Index_Index`
# MAGIC   UNION ALL
# MAGIC   SELECT
# MAGIC     'Uso Eficiente de Imagens' AS Categoria,
# MAGIC     `Comparacao Nacional do Uso Eficiente de Imagens Medicas_Index_Index` AS Valor,
# MAGIC     COUNT(*) AS Quantidade
# MAGIC   FROM
# MAGIC     df_final
# MAGIC   GROUP BY
# MAGIC     `Comparacao Nacional do Uso Eficiente de Imagens Medicas_Index_Index`
# MAGIC )
# MAGIC SELECT
# MAGIC   *
# MAGIC FROM
...
# MAGIC       'Seguranca Atendimento' AS `Seguranca Atendimento`,
# MAGIC       'Readmissao' AS `Readmissao`,
# MAGIC       'Experiencia Paciente' AS `Experiencia Paciente`,
...
categorical_columns = [
    "Comparacao Nacional de Seguranca do Atendimento_Index_Index", 
    "Comparacao Nacional de Readmissao_Index_Index", 
    "Comparacao Nacional da Experiencia do Paciente_Index_Index", 
    "Comparacao Nacional da Efetividade do Atendimento_Index_Index", 
    "Comparacao Nacional da Pontualidade do Atendimento_Index_Index", 
    "Comparacao Nacional do Uso Eficiente de Imagens Medicas_Index_Index"
]
...
# MAGIC SELECT
# MAGIC   `Propriedade Hospitalar_Index_Index` AS Tipo_Hospital,
# MAGIC   AVG(
# MAGIC     CAST(
# MAGIC       `Comparacao Nacional de Mortalidade_Index_Index` AS DOUBLE
# MAGIC     )
# MAGIC   ) AS Media_Taxa_Mortalidade
# MAGIC FROM
# MAGIC   df_final
# MAGIC GROUP BY
# MAGIC   `Propriedade Hospitalar_Index_Index`
# MAGIC ORDER BY
...
# MAGIC   AVG(
# MAGIC     CAST(
# MAGIC       f.`Comparacao Nacional de Mortalidade_Index_Index` AS DOUBLE
# MAGIC     )
# MAGIC   ) AS Media_Taxa_Mortalidade
# MAGIC FROM
# MAGIC   df_final f
# MAGIC   JOIN Tipo_Hospital_Map m ON f.`Propriedade Hospitalar_Index_Index` = m.Tipo_Hospital_Index
# MAGIC GROUP BY
# MAGIC   m.Tipo_Hospital
# MAGIC ORDER BY
# MAGIC   Media_Taxa_Mortalidade DESC;
...
result = spark.sql(
    ...
    SELECT 
        m.Tipo_Hospital,
        AVG(CAST(f.`Comparacao Nacional de Mortalidade_Index_Index` AS DOUBLE)) AS Media_Taxa_Mortalidade
    FROM 
        df_final f
    JOIN 
        Tipo_Hospital_Map m
    ON 
        f.`Propriedade Hospitalar_Index_Index` = m.Tipo_Hospital_Index
    GROUP BY 
        m.Tipo_Hospital
    ORDER BY 
...
plt.figure(figsize=(10, 6))
sns.scatterplot(
    x="Comparacao Nacional da Efetividade do Atendimento_Index_Index",
    y="Comparacao Nacional de Readmissao_Index_Index",
    data=pandas_df,
)
